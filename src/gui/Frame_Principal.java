...
public class Frame_Principal extends javax.swing.JFrame {
    ...
    public Frame_Principal() {
        ...
        //mudando de paineis
        trocaPanel(new Panel_Inicio(this));
    }
    
    public void trocaPanel(JPanel newPanel){
        //remove painel existente
        conteudoFrame.removeAll();
        //se adapta ao tamanho original
        JScrollPane painelBarraRolagem = new JScrollPane(newPanel);
